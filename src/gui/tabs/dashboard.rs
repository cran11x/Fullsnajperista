        ...
        ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                ...
                ui.add(egui::ProgressBar::new(helius_rate)
                    .fill(egui::Color32::from_rgb(120, 180, 255))
                    .desired_width(180.0));
            });
            ...
            ui.vertical(|ui| {
                ...
                ui.add(egui::ProgressBar::new(jito_rate)
                    .fill(egui::Color32::from_rgb(255, 210, 110))
                    .desired_width(180.0));
            });
            ...
            ui.vertical(|ui| {
                ui.label(egui::RichText::new("RPC")
                    .size(14.0)
                    .strong()
                    .color(egui::Color32::from_rgb(160, 255, 190)));
                ui.add_space(4.0);
                ...
                ui.add(egui::ProgressBar::new(rpc_rate)
                    .fill(egui::Color32::from_rgb(150, 255, 160))
                    .desired_width(180.0));
            });
        });
    });
    ...
    ui.group(|ui| {
        ...
        ui.horizontal(|ui| {
            ...
            ui.label(egui::RichText::new(format!("Creator Count: {}", m.filtered_by_creator_count))
                .size(13.0)
                .color(egui::Color32::from_rgb(255, 190, 140)));
